...
def straighten_robot_right():
    ...
    ANGLE_RELATIVE_TO_WALL = int((IDEAL_WALL_DISTANCE - dist_6)/10)
    ABS_ANGLE_RELATIVE_TO_WALL = abs(ANGLE_RELATIVE_TO_WALL)
    CORRECTION_SPEED = int(100 * MASTER_SPEED * (1 - (ABS_ANGLE_RELATIVE_TO_WALL)))
...
while not motor_serial.shutdown_now :
    ...
    # 1=front 1, 2= front 2 , 3= front right, 4= back left, 5= front left, 6= back left
    ...
    if dist_5 or dist_6 > TURN_LEFT_DISTANCE:
